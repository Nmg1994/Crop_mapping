...
Searching the optimiazed initial 1DSpecCNNs architecture
"""
...
print('Searching the optimiazed initial 1DSpecCNNs architecture')
...
# Function to create and compile a 1DSpecCNNs
...
workbook_CNN = xlsxwriter.Workbook("CNN_architecture_spectral.xlsx")
...
# Training and evaluating the 1DSpecCNNs architectures using training and validation samples, respectively
for architecture_name, architecture in architectures.items():
  ...
  for num_layers, num_filters, drop_val in product(layer_counts, filter_counts, dropout):
    # Creating and compiling a 1DSpecCNNs model
