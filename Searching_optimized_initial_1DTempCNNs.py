...
Searching the optimiazed initial 1DTempCNNs architecture
"""
...
print('Searching the optimiazed 1DTempCNNs architecture')
...
workbook_CNN = xlsxwriter.Workbook("CNN_architecture.xlsx")
